...
function HeadphoneCart() {
    ...
    const headphoneProduct = ProductsData.filter(headphone => headphone.item === 'headphones');
    ...
    return (
        <div className="cart">
            <h1 className="cart_head">Headphones</h1>
            <Slider {...settings} className="full_slider">

                {headphoneProduct.map((e) => {
